<template>
    <div class="header">
        <div class="headerBox">
            <div class="headerContainer clear_f">
                <div class="headerLeftr f_left">
                    <ul class="clear_f">
                        <li class="f_left">
                            <router-link to="/"><h1 class="logo">听心</h1></router-link>
                        </li>
                    </ul>
                </div>
                <div class="headerRight f_right">
                    <ul class="clear_f">
                        ...
                        <!--                        </li>-->
                        <!--                        <li class="f_left userli" :class="{active : $route.path==='/code' }">-->
                        <!--                            <router-link to="code">代码生成器</router-link>-->
                        <!--                        </li>-->
...
<style scoped lang="stylus">
    .header
        ...
        .headerContainer
            ...
            .logo
                background: url("~@/assets/common/img/logo.png") no-repeat;
