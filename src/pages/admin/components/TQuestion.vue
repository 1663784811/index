...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/config/jsonObj/tQuestion";

    import {
        API_findPageTQuestion
    } from "@/config/api/tQuestion";


    export default {
        name: "BasePage_TQuestion",
        components: {
            BaseOperation,
            BaseWindow
        },
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findPageTQuestion(this.requestTableData).then(res => {
