        ...
        <div class="tableBox scroll">
            ...
            >
                ...
                <template slot-scope="{row}" slot="powertype">
                    <span v-if="row.powertype === 1">菜单</span>
                    <span v-else-if="row.powertype === 2">按钮</span>
                </template>
                <template slot-scope="{row}" slot="status">
                    <span v-if="row.status === 1">正常</span>
                    <span v-else-if="row.status === 2">锁定</span>
                </template>
            </Table>
        </div>
        <!--===========    操作弹出层     ==============-->
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllTPower(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addTPower(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateTPower(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdTPower(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delTPower(sendObj).then(responseData => {
