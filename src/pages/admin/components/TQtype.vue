...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/config/jsonObj/tQtype";

    import {
        API_findPageTQtype,
        API_delTQtype,
        API_saveTQtype
    } from "@/config/api/tQtype";


    export default {
        name: "BasePage_TQtype",
        components: {
            BaseOperation,
            BaseWindow
        },
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findPageTQtype(this.requestTableData).then(res => {
            ...
            submitDataFn: function () {
                ...
                API_saveTQtype(this.submitData).then(() => {
                    this.winShow = false;
            ...
            delIdFn: function (sendObj) {
                API_delTQtype(sendObj).then(responseData => {
